...
public class PointHistoryVO {
	...
	public PointHistoryVO(int pointHistoryNo, String id, ReviewVO reviewVO, CommentsVO commentsVO,
			ProductOrderVO productOrderVO, int point, String pointHistoryContents, String currentTime) {
		super();
	...
	public String toString() {
		return "PointHistoryVO [pointHistoryNo=" + pointHistoryNo + ", id=" + id + ", reviewVO=" + reviewVO
				+ ", commentsVO=" + commentsVO + ", productOrderVO=" + productOrderVO + ", point=" + point
				+ ", pointHistoryContents=" + pointHistoryContents + ", currentTime=" + currentTime + "]";
	}
}
