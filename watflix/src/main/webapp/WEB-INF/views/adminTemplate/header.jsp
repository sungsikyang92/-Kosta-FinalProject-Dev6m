...
<div id="subMenu">
	<ul id="sub">
		...
		<li>
			<ul>
				<li><a class="nav-link navbar-nav-item" href="#">평점게시물</a></li>
				<li><a class="nav-link navbar-nav-item" href="#">리뷰게시물</a></li>
				<li><a class="nav-link navbar-nav-item" href="#">신고게시물</a></li>
			</ul>
		</li>
		<li>
			<ul>
		...
		<li>
			<ul>
				<li><a class="nav-link navbar-nav-item" href="#">공지사항 등록</a></li>
				<li><a class="nav-link navbar-nav-item" href="#">공지사항 관리</a></li>
			</ul>
		</li>
	</ul>
</div>
